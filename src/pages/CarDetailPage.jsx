...
const CarDetailPage = () => {
  ...
  // Fetch related cars based on actual car's listingType
  useEffect(() => {
    if (!car) return;
    ...
    axios
      ...
      .then((response) => {
        const filtered = response.data.filter(
          (c) => c.listingType === car.listingType && c._id !== id
        );
  ...
  return (
    <div className="bg-white text-gray-800 min-h-screen font-urbanist">
      <div className="max-w-full mx-auto my-8 p-4 md:p-8 bg-white rounded-xl shadow-lg">
              ...
              {car.features?.length > 0 && (
                <div className="flex flex-wrap gap-2 pt-3">
                  {car.features.slice(0, 5).map((feature, i) => (
                    <span
                      key={i}
                      className="bg-green-50 text-green-700 px-3 py-1 text-base rounded-2xl"
                    >
                      {feature}
                    </span>
                  ))}
        ...
        {/* Description and Buy/Rent Button */}
        ...
        {relatedCars.length > 0 && (
          <div className="mt-10 border-t pt-6">
            <h3 className="text-3xl font-semibold mb-4">Related Cars</h3>
                ...
                >
                  <img
                    src={
                      ...
                      "https://res.cloudinary.com/dyl33uzua/image/upload/fallback.jpg"
                    }
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-sm text-gray-600">
                      ₹{relatedCar.price?.toLocaleString()} - {relatedCar.year}
                    </p>
                  </div>
                </div>
              ))}
